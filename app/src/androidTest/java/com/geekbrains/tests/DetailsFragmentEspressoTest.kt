...
class DetailsFragmentEspressoTest {
    ...
    fun fragment_testBundle() {
        ...
        onView(withId(R.id.totalCountTextViewDetail)).check(assertion)
    }
    ...
    fun fragment_testIncrementButton() {
        ...
        onView(withId(R.id.totalCountTextViewDetail)).check(matches(withText(TEST_NUMBER_OF_RESULTS_PLUS_1)))
    }

    @Test
    fun fragment_testDecrementButton() {
        onView(withId(R.id.decrementButton)).perform(click())
        onView(withId(R.id.totalCountTextViewDetail)).check(matches(withText(TEST_NUMBER_OF_RESULTS_MINUS_1)))
    }
